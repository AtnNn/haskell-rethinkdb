...
module Database.RethinkDB.Protobuf.Ql2.Query2.AssocPair (AssocPair(..)) where
import Prelude ((+), (/))
...
data AssocPair = AssocPair{key :: !P'.Utf8, val :: !Ql2.Term2}
