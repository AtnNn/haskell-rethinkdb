...
module Database.RethinkDB.Protobuf.Ql2.Response2.ResponseType (ResponseType(..)) where
import Prelude ((+), (/), (.))
...
instance Prelude'.Enum ResponseType where
  ...
  toEnum
   = P'.fromMaybe
      (Prelude'.error "hprotoc generated code: toEnum failure for type Database.RethinkDB.Protobuf.Ql2.Response2.ResponseType")
      . toMaybe'Enum
  ...
  succ _ = Prelude'.error "hprotoc generated code: succ failure for type Database.RethinkDB.Protobuf.Ql2.Response2.ResponseType"
  ...
  pred _ = Prelude'.error "hprotoc generated code: pred failure for type Database.RethinkDB.Protobuf.Ql2.Response2.ResponseType"
...
instance P'.ReflectEnum ResponseType where
  ...
  reflectEnumInfo _
   = P'.EnumInfo
      (P'.makePNF (P'.pack ".Ql2.Response2.ResponseType") ["Database", "RethinkDB", "Protobuf"] ["Ql2", "Response2"] "ResponseType")
      ["Database", "RethinkDB", "Protobuf", "Ql2", "Response2", "ResponseType.hs"]
