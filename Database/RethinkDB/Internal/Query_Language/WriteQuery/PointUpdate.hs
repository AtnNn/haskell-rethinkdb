...
module Database.RethinkDB.Internal.Query_Language.WriteQuery.PointUpdate (PointUpdate(..)) where
import Prelude ((+), (/))
...
data PointUpdate = PointUpdate{table_ref :: !Query_Language.TableRef, attrname :: !P'.Utf8, key :: !Query_Language.Term,
                               mapping :: !Query_Language.Mapping}
                 deriving (Prelude'.Show, Prelude'.Eq, Prelude'.Ord, Prelude'.Typeable, Prelude'.Data)
 
instance P'.Mergeable PointUpdate where
  mergeAppend (PointUpdate x'1 x'2 x'3 x'4) (PointUpdate y'1 y'2 y'3 y'4)
   = PointUpdate (P'.mergeAppend x'1 y'1) (P'.mergeAppend x'2 y'2) (P'.mergeAppend x'3 y'3) (P'.mergeAppend x'4 y'4)
 
instance P'.Default PointUpdate where
  defaultValue = PointUpdate P'.defaultValue P'.defaultValue P'.defaultValue P'.defaultValue
 
instance P'.Wire PointUpdate where
  wireSize ft' self'@(PointUpdate x'1 x'2 x'3 x'4)
   = case ft' of
       10 -> calc'Size
  ...
  wirePut ft' self'@(PointUpdate x'1 x'2 x'3 x'4)
   = case ft' of
       10 -> put'Fields
       11 -> do
